...
export const meteorSkills = skillDefinitionSchema.array().parse([
  ...
  { id: 'meteorResonance', name: '軌之共鳴', description: '自己的作品為（燃）時，每回合一次，重擲自身一顆 pending die。', activation: 'active', status: 'implemented', activeUsage: { scope: 'round', limit: 1 }, activeCondition: { kind: 'workType', target: 'ownerWork', types: ['燃'] }, activeTarget: { kind: 'pendingDie', relation: 'self' }, activeEffects: [{ kind: 'custom', handler: 'rerollSelectedOwnerDieIfWorkType', args: { workType: '燃' } }] },
]);
