...
export const eCharacter = characterDefinitionSchema.parse({ id: 'e', name: 'E', stats: { design: 3, text: 2, aa: 0 }, maxStress: 4, affinities: [], skillIds: ['eHiredWriter', 'eSelectedJokes'], portrait: 'assets/characters/portrait/narrator.webp', compactPortrait: 'assets/characters/compact/narrator.webp', sourceNotes: ['2026-09-12 PintBox：Design3/Text2/AA0，壓力4；全作品類型適性；作品為（笑）時Text額外+3。'] });
