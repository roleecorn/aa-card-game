...
export const ingridCharacter = characterDefinitionSchema.parse({ id: 'ingrid', name: 'Ingrid', stats: { design: 2, text: 2, aa: 1 }, maxStress: 4, affinities: ['謀', '情'], skillIds: ['ingridMercuryRetrograde', 'ingridArchitecture'], portrait: 'assets/characters/portrait/ingrid.webp', compactPortrait: 'assets/characters/compact/ingrid.webp', sourceNotes: ['2026-09-12 PintBox：Design2/Text2/AA1，壓力4，適性（謀）（情）；第3回合神隱；第一回合額外得到6/3/1三顆Design。'] });
