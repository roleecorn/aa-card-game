...
export const zhiseCharacter = characterDefinitionSchema.parse({ id: 'zhise', name: '滯澀', stats: { design: 1, text: 1, aa: 1 }, maxStress: 5, affinities: ['謀'], skillIds: ['zhiseHidden', 'zhiseFinalFill'], portrait: 'assets/characters/portrait/narrator.webp', compactPortrait: 'assets/characters/compact/narrator.webp', sourceNotes: ['2026-09-12 PintBox：1/1/1，壓力5，適性（謀）；開局神隱5輪，結算以1d6填滿作品剩餘進度。'] });
